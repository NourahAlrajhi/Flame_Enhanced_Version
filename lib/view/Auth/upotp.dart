...
import 'package:flame/view/Auth/Signup.dart' as signup;
...
class UPOTPScreen extends StatefulWidget {
  static String id = "UPOTPScreen";
  UPOTPScreen({super.key});

  @override
  State<UPOTPScreen> createState() => _UPOTPScreenState();
}

class _UPOTPScreenState extends State<UPOTPScreen> {
  String otp = '';
  String otp1 = '';
  String otp2 = '';
  String otp3 = '';
        ...
        children: [
                      ...
                      child: TextFormField(
                        ...
                        onChanged: (value) async {
                          if (value.length == 1) {
                            ...
                            result = await signup.SignupOTP(otp);
                            setState(() {
                              result;
                            });
                            if (result) {
                              Navigator.push(
                                ...
                                MaterialPageRoute(
                                  builder: (context) => RegisterScreen(
                                    num: signup.auth.currentUser!.phoneNumber,
                                  ),
                                ),
                              );
                              SaveData.setData(
                                  key: 'idUser',
                                  value: signup.auth.currentUser!.uid);
                              ...
                              showCupertinoDialog(
                                  ...
                                  builder: (context) {
                                    return CupertinoAlertDialog(
                                      ...
                                      content: Text(
                                          "Do you want to go to sign in screen?",
                                          style: TextStyle(
                                            fontFamily: 'Tajawal',
                                          )),
                                      actions: [
                              ...
                              // AlertDialog(
                              //   title: Text("This number is already registered"),
                              //   content: Text("Do you want to go to sign in screen?"),
                              //   actions: [
                              //     FlatButton("No"),
                              //     FlatButton("Yes"),
                              //   ],
          ...
          Visibility(
            ...
            child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
              InkWell(
                onTap: () {
                  signup.SignupWithPhone(context);
                },
